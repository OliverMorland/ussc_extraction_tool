...
model_to_train = './custody_state_trained_distilbert'
...
dataset = load_dataset('json', data_files={'train': 'probation_dataset_500.json'})
...
model_path = './probation_custody_state_trained_distilbert'
